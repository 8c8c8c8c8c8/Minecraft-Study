...
public class NewPlacedFeatures {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context,
                ...
                configuredFeatures.getOrThrow(NewConfiguredFeatures.OVER_WORLD_SAPPHIRE_ORE_KEY),
                NewOrePlacements.commonOrePlacement(12,
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(80))));
        register(context,
                NETHER_SAPPHIRE_ORE_PLACED_KEY,
                configuredFeatures.getOrThrow(NewConfiguredFeatures.NETHER_SAPPHIRE_ORE_KEY),
                NewOrePlacements.commonOrePlacement(12,
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(80))));
        register(context,
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(MinecraftStudy.MOD_ID, name));
    }
