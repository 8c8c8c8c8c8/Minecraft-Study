package zz.dbrvkf.minecraft_study.sound;
...
public class NewSounds {
    public static final DeferredRegister<SoundEvent> SOUND_EVENTS =
            DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, MinecraftStudy.MOD_ID);
    ...
    public static final ForgeSoundType SOUND_BLOCK_SOUNDS = new ForgeSoundType(1f, 1f,
            NewSounds.SOUND_BLOCK_BREAK, NewSounds.SOUND_BLOCK_STEP, NewSounds.SOUND_BLOCK_PLACE,
            NewSounds.SOUND_BLOCK_HIT, NewSounds.SOUND_BLOCK_FALL);

    private static RegistryObject<SoundEvent> registerSoundEvents(String name) {
        return SOUND_EVENTS.register(name,
                () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(MinecraftStudy.MOD_ID, name)));
    }
